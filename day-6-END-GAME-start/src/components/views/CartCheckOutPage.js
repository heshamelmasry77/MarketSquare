            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                {productsInCart.length > 0 ? <div className="flex h-full flex-col overflow-y-scroll bg-white">
                    ...
                    <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                        ...
                        <div className="mt-6">
                            <a href="#"
                               className="flex items-center justify-center rounded-md border border-transparent bg-teal-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-teal-700">Checkout</a>
                        </div>
