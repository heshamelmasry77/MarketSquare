                            ...
                            <div className="flex h-16 items-center">
                                ...
                                <div className="ml-auto flex items-center">
                                    <div className="space-x-2 lg:space-x-6 flex flex-1 items-center justify-end">
                                        <a href="#" className="text-xs lg:text-sm font-medium text-gray-700 hover:text-gray-800">All Products</a>
                                        <span className="h-6 w-px bg-gray-200" aria-hidden="true"></span>
                                        <a href="#" className="text-xs lg:text-sm font-medium text-gray-700 hover:text-gray-800">Contact Us</a>
                                    </div>
